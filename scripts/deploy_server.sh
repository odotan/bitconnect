 ...
 */
var siteMap = {
    bitconnect_refs_heads_master: { updateCmd : "cd /root/bitconnect; git pull; ./scripts/minify.sh; forever stop server.js; forever start server.js;" },
  }
